...
const Brands = () => {
  return (
    <div className='flex flex-col max-w-[1050px] m-auto px-4 py-24 mdl:py-32'> 
        <h1 className='text-neutral-2 font-normal text-base mdl:text-xl mdl:leading-relaxed'>I have had the opportunity to work on various <span className='text-neutral-1 font-semibold'>Branding, Logo design, Web design</span> projects for both local 
        ...
        <div className="flex flex-col items-center justify-center text-center">
            <h1 className='font-light text-neutral-1 text-xl py-[70px] mdl:text-3xl' >Some Logo <span className='text-primary font-semibold'> Brand Designs</span> that I’ve worked</h1>
            <div className="flex flex-row flex-wrap gap-9 justify-center items-center mt-4 gap-y-12">
                <Image 
                    src={woop_brand}
                    alt='Woop'
