...
//   return (
//     <div className="w-[1216px] flex flex-row items-center justify-between m-auto sticky top-0 py-4  z-10 backdrop-filter backdrop-blur-lg bg-opacity-30 border-b border-gray-900">
//         <motion.div
//             initial={{opacity: 0}}
//             animate={{opacity: 1}}
